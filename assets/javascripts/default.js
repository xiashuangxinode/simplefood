...
// 		}
		...
		// var cn_font_plugs = document.createElement('script');
		// cn_font_plugs.src = '/assets/javascripts/simsun-normal.js';
		// document.body.appendChild(cn_font_plugs);


		/*var doc = new jsPDF('','pt' ,'a4');
		doc.setFont('simsun','normal');
		doc.text(20, 225, 'NUTRITIO我是你的N INFOMATION');	
		...
		// var draw_line = function(x1,y1,x2,y2,options){}


		// //595.28, 841.89
		// var canvas_id = "12345678901234567890123456789012".split('').map(function () {
  //         return "ABCDEF0123456789".charAt(Math.floor(Math.random() * 16));
  //       }).join('');

		// var cookbook_canvas = document.createElement('canvas');
		// cookbook_canvas.id = canvas_id;
		// cookbook_canvas.width = 595.28;
		// cookbook_canvas.height = 841.89;
		// document.body.appendChild(cookbook_canvas);

		// var ctx = cookbook_canvas.getContext('2d')

		// ctx.lineWidth = 3;
		// ctx.beginPath();
		// ctx.moveTo(30,20);
		// ctx.lineTo(575.28,20);
		// ctx.stroke();


		// // ctx.fillText(ni,20,30,100);
		// ctx.fillText(ni, 20, 40);
